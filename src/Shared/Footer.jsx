...
const Footer = () => {
    return (
        <footer className="  lg:w-full divide-y dark:bg-gray-800 dark:text-gray-100">
	<div className="container flex  flex-col justify-center items-center lg:justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
    ...
    <span className="ml-2 text-sm font-extrabold text-orange-400 text-center w-[7rem]"> Group Assignment</span>
		...
		<div className="grid grid-cols-2 text-sm gap-x-20 lg:gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			...
			<div className="space-y-3">
				...
				<div className="flex justify-start space-x-3">
					...
					<a rel="noopener noreferrer" href="https://www.twitter.com/" title="Twitter" className="flex items-center p-1">
					...
					<a rel="noopener noreferrer" href="https://www.instragram.com/" title="Instagram" className="flex items-center p-1">
	...
	<div className="py-3 text-sm text-center dark:text-gray-400">© 1968 Company Co. All rights reserved.</div>
</footer>
    );
};
